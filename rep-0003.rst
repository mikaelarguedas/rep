...
As of ROS Lunar, we do not build packages fo x86 architectures. Ubuntu switched its default to 64bits and we noticed a significant decrease of ROS packages downloads for this architecture.
